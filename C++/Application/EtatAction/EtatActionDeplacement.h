...
/// @{
//////////////////////////////////////////////////////////////////////////////
#ifndef __APPLICATION_ETATACTIONDEPLACEMENT_H__
#define __APPLICATION_ETATACTIONDEPLACEMENT_H__

#include "EtatActionAbstrait.h"

class EtatActionDeplacement : public EtatActionAbstrait
{
protected:
	int lastDragX;
	int lastDragY;
public:
	EtatActionDeplacement();
...
#endif // __APPLICATION_ETATACTIONDEPLACEMENT_H__
